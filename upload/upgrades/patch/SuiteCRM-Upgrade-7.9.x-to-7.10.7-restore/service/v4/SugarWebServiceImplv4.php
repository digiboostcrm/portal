...
class SugarWebServiceImplv4 extends SugarWebServiceImplv3_1 {
    ...
    public function login($user_auth, $application = null, $name_value_list = array()){
        $GLOBALS['log']->fatal("Begin: SugarWebServiceImpl->login({$user_auth['user_name']}, $application, ". print_r($name_value_list, true) .")");
        ...
        self::$helperObject->setFaultObject($error);
        $GLOBALS['log']->fatal('End: SugarWebServiceImpl->login - failed login');
    }
