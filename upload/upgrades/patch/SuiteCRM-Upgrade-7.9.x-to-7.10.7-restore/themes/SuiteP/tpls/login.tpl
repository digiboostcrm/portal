...
<div class="p_login">
	...
	<div class="p_login_top">
		...
		<a title="Digiboost" href="http://www.Digiboost.com">Digiboost</a>
    ...
    <div class="p_login_bottom">
    		...
    		<a id="admin_options">&copy; Supercharged by Digiboost</a>
            <a id="powered_by">&copy; Powered By Digiboost</a>
