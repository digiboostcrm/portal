...
class OpportunitiesViewEdit extends ViewEdit {
     ...
     */
 	...
 	function display() {
		...
		$lead_source = $_GET['name'];
		$ret_mod = $_GET['return_module'];
		$parent_lead_id = $_GET['return_id'];
		$this->custom_lead_id = $parent_lead_id;
		/*Start 01-02-2018*/
		...
		/*end 01-02-2018*/
		echo '<input type="hidden" name="custom_lead_account" id="custom_lead_account" value="'.$lead_source.'">';
		echo '<input type="hidden" name="return_mod" id="return_mod" value="'.$ret_mod.'">';
		echo '<input type="hidden" name="parent_lead_id" id="parent_lead_id" value="'.$parent_lead_id.'">';
