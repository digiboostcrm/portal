<?php /* Smarty version 2.6.31, created on 2019-02-21 21:06:30
         compiled from cache/themes/SuiteP/modules/Tasks/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 48, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 104, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 175, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 277, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 476, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 65, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 86, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 111, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 150, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 178, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 449, false),array('block', 'minify', 'cache/themes/SuiteP/modules/Tasks/EditView.tpl', 102, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_RIGHTSIGNATURE">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RIGHTSIGNATURE','module' => 'Tasks'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="rightsignature_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<input type="text" name="<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['rightsignature_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['rightsignature_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['rightsignature_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['ut_rightsignature_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['rightsignature_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"ut_rightsignature_id_c","name":"rightsignature_c"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['rightsignature_c']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['rightsignature_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php echo '\' );
addToValidate(\'EditView\', \'rightsignature_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RIGHTSIGNATURE','module' => 'Tasks','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'ut_rightsignature_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RIGHTSIGNATURE_UT_RIGHTSIGNATURE_ID','module' => 'Tasks','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NAME','module' => 'Tasks','for_js' => true), $this);?>
<?php echo '\', \'contact_id\' );
addToValidateBinaryDependency(\'EditView\', \'rightsignature_c\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Tasks','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RIGHTSIGNATURE','module' => 'Tasks','for_js' => true), $this);?>
<?php echo '\', \'ut_rightsignature_id_c\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_parent_name\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_contact_name\']={"form":"EditView","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_name","contact_id","contact_id","contact_id"],"required_list":["contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_rightsignature_c\']={"form":"EditView","method":"query","modules":["UT_RightSignature"],"group":"or","field_list":["name","id"],"populate_list":["rightsignature_c","ut_rightsignature_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
