<?php /* Smarty version 2.6.31, created on 2019-02-26 01:31:34
         compiled from modules/rls_Reports/license/tpls/license.tpl */ ?>
...
<script type="text/javascript">
    ...
    if (typeof(jQuery) == \'undefined\') {
        ...
        getScript(\''; ?>
<?php echo $this->_tpl_vars['file_path']; ?>
<?php echo '\', function() {
    ...
    function outfitters_validate_license()
    {
        ...
        $.ajax(\'index.php?module='; ?>
<?php echo $this->_tpl_vars['MODULE']; ?>
<?php echo '&action=outfitterscontroller&to_pdf=1\',{
            type: \'POST\',
            dataType: \'json\',
            data: {
                method: \'validate\',
            ...
            success: function(response){
                ...
                if (response){
                    if(response.validated == true) {
                        ...
                        console.log(licKey.length);
                        if(licKey.length==35){
                            console.log("55555");
                            $(\'#outfitters_additional_license_form\').removeClass(\'hidden\');
                        }else{
                            console.log("1111");
                            $(\'#outfitters_additional_license_form\').addClass(\'hidden\');
                        }
...
<?php if ($this->_tpl_vars['validate_users'] == true && $this->_tpl_vars['manage_licensed_users'] == true): ?>
...
<?php echo '
                    ...
                    if(response.licensed_user_count != undefined) {
                        ...
                        if(response.validated_users == true) {
                            ...
                            $(\'#btn-outfitters-increase\').html(\'Increase to '; ?>
<?php echo $this->_tpl_vars['current_users']; ?>
<?php echo ' users\');
    ...
    function outfitters_increase_license(increase_to)
    {
        ...
        if(licKey.length == 35){
            window.location.href="http://www.richlodesolutions.com/recruitment-purchase";
            return;
        }
...
<?php echo '&action=outfitterscontroller&to_pdf=1\',{
    ...
    {
'; ?>
<?php if ($this->_tpl_vars['validate_users'] == true && $this->_tpl_vars['manage_licensed_users'] == true): ?><?php echo '
        ...
        if(avail_users<0){
            $(\'#outfitters_additional_licenses\').val(Math.abs(avail_users));
        }
...
<?php if ($this->_tpl_vars['validate_users'] == true && $this->_tpl_vars['manage_licensed_users'] == true): ?><?php echo '
    ...
    function outfitters_save_licensed_users()
    {
        ...
        if(avail_users < 0)
        {
            ...
            $(\'#outfitters_save_licensed_users_fail_message\').html(\''; ?>
<?php echo $this->_tpl_vars['LICENSE']['LBL_ERROR_TOO_MANY_USERS']; ?>
<?php echo '\');
            return false;
        }
...
">
    <input type="hidden" name="licensed_users" id="licensed_users" value="<?php echo $this->_tpl_vars['licensed_users']; ?>
">
    <input type="hidden" name="available_users" id="available_users" value="<?php echo $this->_tpl_vars['available_licensed_users']; ?>
">

<table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
    <tr><th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['LICENSE']['LBL_STEPS_TO_LOCATE_KEY_TITLE']; ?>
</h4></th></tr>
    <tr>
        <td align="left" scope="row" colspan="4">
            <?php echo $this->_tpl_vars['LICENSE']['LBL_STEPS_TO_LOCATE_KEY']; ?>

        </td>
   </tr>
    <tr>
        <td width="20%" scope="row" style="vertical-align: middle"><?php echo $this->_tpl_vars['LICENSE']['LBL_LICENSE_KEY']; ?>
</td>
        <td width="30%" colspan="3" scope="row">
            <input id='outfitters_license_key' name='outfitters_license_key' class='outfitters_license_key' tabindex='1' size='50' maxlength='100' type="text" value="<?php echo $this->_tpl_vars['license_key']; ?>
">
            <input title="<?php echo $this->_tpl_vars['LICENSE']['LBL_VALIDATE_LABEL']; ?>
" class="button primary" onclick="return outfitters_validate_license();" type="submit" name="button" id="btn-outfitters-validate-license" value=" <?php echo $this->_tpl_vars['LICENSE']['LBL_VALIDATE_LABEL']; ?>
 ">
            ...
            <span id="outfitters_validation_success" style="display: none">
                ...
                <?php if ($this->_tpl_vars['validate_users'] == false && ! empty ( $this->_tpl_vars['continue_url'] )): ?>
                    <br/><br/>
                    <input title="Continue" class="button primary" onclick="window.location='<?php echo $this->_tpl_vars['continue_url']; ?>
';" type="button" name="button" value=" Continue ">
                <?php endif; ?>
            </span>
        </td>
    </tr>
...
<?php if ($this->_tpl_vars['validate_users'] == true): ?>

    <?php if ($this->_tpl_vars['manage_licensed_users'] == false): ?>
        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
            <tr>
                <td width="20%" scope="row"></td>
                <td width="30%" scope="row"></td>
            ...
            <tr>
                <td width="20%" scope="row"><?php echo $this->_tpl_vars['LICENSE']['LBL_CURRENT_USERS']; ?>
</td>
                <td width="30%" scope="row" id="outfitters_current_users"><?php echo $this->_tpl_vars['current_users']; ?>
</td>
                <td width="20%" scope="row"></td>
                <td width="30%" scope="row"></td>
            </tr>
            <tr>
                <td width="20%" scope="row"><?php echo $this->_tpl_vars['LICENSE']['LBL_LICENSED_USERS']; ?>
</td>
                <td width="30%" scope="row" colspan="3">
                    ...
                    <span id="outfitters_license_increase" style="display: none">
                        ...
                        <br/>
                        <button id="btn-outfitters-increase" onclick="javascript:outfitters_increase_license(<?php echo $this->_tpl_vars['current_users']; ?>
); return false;">Boost to # users</button>
                    </span>
                    <span id="outfitters_license_passed" style="display: none">
                        <img src="themes/default/images/yes.gif" alt="Passed"></img> Verified!

                        <?php if (! empty ( $this->_tpl_vars['continue_url'] )): ?>
                            <br/><br/>
                            <input title="Continue" class="button primary" onclick="window.location='<?php echo $this->_tpl_vars['continue_url']; ?>
';" type="button" name="button" value=" Continue ">
                        <?php endif; ?>
    ...
    <?php else: ?>
        <?php if ($this->_tpl_vars['validation_required'] == true): ?>
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view validation-required">
                <tr><th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['LICENSE']['LBL_MANAGE_USERS_TITLE']; ?>
</h4></th></tr>
                <tr>
                    <td width="20%" scope="row"></td>
                    <td width="30%" scope="row"></td>
                ...
                <tr>
                    <td colspan="4" scope="row"><?php echo $this->_tpl_vars['LICENSE']['LBL_VALIDATION_REQUIRED']; ?>
</td>
                </tr>
            </table>
        <?php endif; ?>
        <form name="outfitters_additional_license_form" class="<?php if ($this->_tpl_vars['rls_manage_licensed_users'] == false): ?>hidden<?php endif; ?>" id="outfitters_additional_license_form" method="POST" >
            <input type="hidden" name="method" value="add"/>
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view manage-users" <?php if ($this->_tpl_vars['validation_required'] == true): ?>style="display: none"<?php endif; ?>>
                <tr><th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['LICENSE']['LBL_MANAGE_USERS_TITLE']; ?>
</h4></th></tr>
                <tr>
                    <td width="20%" scope="row"></td>
                ...
                <tr>
                    <td width="20%" scope="row"><?php echo $this->_tpl_vars['LICENSE']['LBL_LICENSED_USERS']; ?>
:</td>
                    <td width="30%" scope="row" id="outfitters_licensed_users"><?php echo $this->_tpl_vars['licensed_users']; ?>
</td>
                    <td width="20%" scope="row"></td>
                    <td width="30%" scope="row"></td>
                </tr>
                <tr>
                    <td width="20%" scope="row"><?php echo $this->_tpl_vars['LICENSE']['LBL_AVAILABLE_USERS']; ?>
:</td>
                    <td width="30%" scope="row">
                        <span id="outfitters_available_licensed_users"><?php echo $this->_tpl_vars['available_licensed_users']; ?>
</span>
                    </td>
                    <td width="20%" scope="row"></td>
                    <td width="30%" scope="row"></td>
                ...
                <tr id="outfitters_show_additional_licenses">
                    <td width="20%" scope="row"><?php echo $this->_tpl_vars['LICENSE']['LBL_HOW_MANY_USERS']; ?>
:</td>
                    <td scope="row" colspan="3">
                        <div id="outfitters_additional_license_increase">
                            <input type="text" name="outfitters_additional_licenses" id="outfitters_additional_licenses" size="6" value="0"/>
                            <input title="<?php echo $this->_tpl_vars['LICENSE']['LBL_ADD_USERS_BUTTON_LABEL']; ?>
" class="button primary" onclick="return outfitters_save_additional_users();" type="button" name="button" id="btn-outfitters-additional-users" value=" <?php echo $this->_tpl_vars['LICENSE']['LBL_ADD_USERS_BUTTON_LABEL']; ?>
 ">
                        </div>
                ...
                <tr>
                    <td colspan="4" scope="row">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td scope="row" align="left" style="padding-bottom: 2em;"><?php echo $this->_tpl_vars['USER_CHOOSER']; ?>
</td>
...
" class="button primary btn-outfitters-big" onclick="return outfitters_save_licensed_users();" type="button" name="button" id="btn-outfitters-licensed-users" value=" <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
 ">
                        ...
                        <span id="outfitters_save_licensed_users_success" style="display: none">
                            ...
                            <?php if (! empty ( $this->_tpl_vars['continue_url'] )): ?>
                                <input title="Continue" class="button primary btn-outfitters-big" onclick="window.location='<?php echo $this->_tpl_vars['continue_url']; ?>
';" type="button" name="button" value=" Continue ">
                            <?php endif; ?>
                        </span>
                    </td>
                ...
                <tr>
                    <td scope="row" colspan="4"><div style="margin-top: 18px"><em><?php echo $this->_tpl_vars['LICENSE']['LBL_HOWTO_REDUCE_LICENSE']; ?>
</em></div></td>
                </tr>
            </table>
        </form>
