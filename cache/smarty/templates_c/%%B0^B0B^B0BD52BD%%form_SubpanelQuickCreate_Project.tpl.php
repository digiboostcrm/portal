<?php /* Smarty version 2.6.31, created on 2019-02-07 04:06:18
         compiled from cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 62, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 83, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 108, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 146, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 174, false),array('block', 'minify', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 99, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 101, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 171, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 273, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Project/form_SubpanelQuickCreate_Project.tpl', 428, false),)), $this); ?>
...
"  class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Project'); disableOnUnloadEditView(); _form.action.value='Save';if(check_form('form_SubpanelQuickCreate_Project'))return SUGAR.subpanelUtils.inlineSave(_form.id, 'Project_subpanel_save_button');return false;" type="submit" name="Project_subpanel_save_button" id="Project_subpanel_save_button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"><?php endif; ?> 
<input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="Project_subpanel_cancel_button" id="Project_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
"> 
<input title="<?php echo $this->_tpl_vars['APP']['LBL_FULL_FORM_BUTTON_TITLE']; ?>
" class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Project'); disableOnUnloadEditView(_form); _form.return_action.value='DetailView'; _form.action.value='EditView'; if(typeof(_form.to_pdf)!='undefined') _form.to_pdf.value='0';" type="submit" name="Project_subpanel_full_form_button" id="Project_subpanel_full_form_button" value="<?php echo $this->_tpl_vars['APP']['LBL_FULL_FORM_BUTTON_LABEL']; ?>
...
<?php echo smarty_function_sugar_translate(array('label' => '','module' => 'Project'), $this);?>
