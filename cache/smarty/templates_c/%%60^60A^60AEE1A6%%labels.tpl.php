<?php /* Smarty version 2.6.31, created on 2019-02-07 18:44:26
...
<table class='mbLBL'>
    ...
    <?php $_from = $this->_tpl_vars['MOD_LABELS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
