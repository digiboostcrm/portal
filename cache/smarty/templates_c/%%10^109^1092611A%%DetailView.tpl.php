<?php /* Smarty version 2.6.31, created on 2019-03-07 18:33:19
         compiled from cache/themes/SuiteP/modules/dg_comments/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 107, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 272, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 100, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 240, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 240, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/dg_comments/DetailView.tpl', 240, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='dg_comments'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='dg_comments'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='dg_comments'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='dg_comments'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
&module_name=dg_comments", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
"><?php endif; ?><?php endif; ?>
</div>                    <?php endif; ?>
</form>
</div>
...
<?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'dg_comments'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'dg_comments'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'dg_comments'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'dg_comments'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'dg_comments'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'dg_comments'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CASES_DG_COMMENTS_1_FROM_CASES_TITLE','module' => 'dg_comments'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="cases_dg_comments_1_name"  >

<?php if (! $this->_tpl_vars['fields']['cases_dg_comments_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['cases_dg_comments_1cases_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Cases&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['cases_dg_comments_1cases_ida']['value']; ?>
...
"><?php endif; ?>
<span id="cases_dg_comments_1cases_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['cases_dg_comments_1cases_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['cases_dg_comments_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['cases_dg_comments_1cases_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_COMMENT_STATUS','module' => 'dg_comments'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="enum" field="status" colspan='3' >
