<?php /* Smarty version 2.6.31, created on 2019-01-28 20:43:29
         compiled from include/SugarEmailAddress/templates/forDuplicatesView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/SugarEmailAddress/templates/forDuplicatesView.tpl', 43, false),)), $this); ?>
...
">
<?php endif; ?>
<?php $_from = $this->_tpl_vars['optOut']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['email']):
?>
<input type="hidden" name="<?php echo $this->_tpl_vars['moduleDir']; ?>
<?php echo $this->_tpl_vars['email_widget_id']; ?>
...
">
<?php endforeach; endif; unset($_from); ?>
<?php $_from = $this->_tpl_vars['invalid']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['email']):
?>
<input type="hidden" name="<?php echo $this->_tpl_vars['moduleDir']; ?>
<?php echo $this->_tpl_vars['email_widget_id']; ?>
...
">
<?php endforeach; endif; unset($_from); ?>
<?php $_from = $this->_tpl_vars['replyTo']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['email']):
?>
<input type="hidden" name="<?php echo $this->_tpl_vars['moduleDir']; ?>
<?php echo $this->_tpl_vars['email_widget_id']; ?>
...
">
<?php endforeach; endif; unset($_from); ?>
<?php $_from = $this->_tpl_vars['delete']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['email']):
?>
<input type="hidden" name="<?php echo $this->_tpl_vars['moduleDir']; ?>
<?php echo $this->_tpl_vars['email_widget_id']; ?>
