<?php /* Smarty version 2.6.31, created on 2019-03-07 21:12:59
         compiled from cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl', 31, false),array('function', 'math', 'cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl', 32, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl', 38, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl', 76, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl', 351, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Accounts/SearchForm_basic.tpl', 160, false),)), $this); ?>
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='active_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Accounts'), $this);?>
</label>
					</div>
...
<?php if (strval ( $this->_tpl_vars['fields']['active_basic']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['active_basic']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['active_basic']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['active_basic']['name']; ?>
"   >
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='account_status_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_STATUS','module' => 'Accounts'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php echo smarty_function_html_options(array('id' => 'account_status_c_basic','name' => 'account_status_c_basic[]','options' => $this->_tpl_vars['fields']['account_status_c_basic']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['account_status_c_basic']['value']), $this);?>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='account_manager_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_MANAGER','module' => 'Accounts'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php echo smarty_function_html_options(array('id' => 'account_manager_c_basic','name' => 'account_manager_c_basic[]','options' => $this->_tpl_vars['fields']['account_manager_c_basic']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['account_manager_c_basic']['value']), $this);?>
...
' title=''  tabindex='-1'      >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='date_entered_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Accounts'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
