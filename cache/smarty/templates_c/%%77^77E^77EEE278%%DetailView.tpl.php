<?php /* Smarty version 2.6.31, created on 2019-02-21 18:31:30
         compiled from cache/themes/SuiteP/modules/Notes/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 47, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 115, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 119, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 108, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 265, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 265, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Notes/DetailView.tpl', 265, false),)), $this); ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_ASSIGNMENT','module' => 'Notes'), $this);?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="notes_type"  >

<?php if (! $this->_tpl_vars['fields']['notes_type']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['notes_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['notes_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['notes_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['notes_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['notes_type']['options'][$this->_tpl_vars['fields']['notes_type']['value']]; ?>
