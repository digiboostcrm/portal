<?php /* Smarty version 2.6.31, created on 2019-03-08 15:58:55
...
?>
          <?php ob_start(); ?><?php echo $this->_tpl_vars['MOD']['LBL_CUSTOM_MAPPING_']; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['item'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('mapping_label', ob_get_contents());ob_end_clean(); ?>
          <tr>
