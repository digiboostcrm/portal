<?php /* Smarty version 2.6.31, created on 2019-01-29 17:53:17
         compiled from themes/SuiteP/modules/Leads/tpls/ConvertLeadHeader.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'themes/SuiteP/modules/Leads/tpls/ConvertLeadHeader.tpl', 127, false),)), $this); ?>
<?php echo '
...
">
                ...
                <?php if (! empty ( $_REQUEST['return_module'] ) || ! empty ( $_REQUEST['relate_to'] )): ?>
                    <input type="hidden" name="relate_to"
                           value="<?php if ($_REQUEST['return_relationship']): ?><?php echo $_REQUEST['return_relationship']; ?>
