<?php /* Smarty version 2.6.31, created on 2019-01-29 18:00:13
         compiled from cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 62, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 83, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 107, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 156, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 304, false),array('function', 'sugar_getscript', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 685, false),array('block', 'minify', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 99, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 101, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 301, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Notes/form_SubpanelQuickCreate_Notes.tpl', 403, false),)), $this); ?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Notes","field_to_name_array":{"id":"contact_id","name":"contact_name"}}'; ?>
, 
"single", 
true
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_NOTES_TYPE">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NOTES_TYPE','module' => 'Notes'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="notes_type"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['notes_type']['value'] ) && $this->_tpl_vars['fields']['notes_type']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['notes_type']['options'],'selected' => $this->_tpl_vars['fields']['notes_type']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['notes_type']['options'],'selected' => $this->_tpl_vars['fields']['notes_type']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['notes_type']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['notes_type']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['notes_type']['name']; ?>
');
...
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=BWAu-qbZlIX_hqvMTT-f-A'></script>
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'contact_id\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_ID','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'contact_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NAME','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'contact_phone\', \'phone\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'contact_email\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESS','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'opportunities_notes_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITIES_NOTES_1_FROM_OPPORTUNITIES_TITLE','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'created_from_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_FROM','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'notes_type\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NOTES_TYPE','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
...
addToValidateBinaryDependency(\'form_SubpanelQuickCreate_Notes\', \'contact_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Notes','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_NAME','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\', \'contact_id\' );
