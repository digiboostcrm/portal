<?php /* Smarty version 2.6.31, created on 2019-03-05 23:35:09
...
<script type="text/javascript" src='cache/include/externalAPI.cache.js?v=rJ6vspMOkOld-QUJJx1Y9g'></script>
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=rJ6vspMOkOld-QUJJx1Y9g'></script>
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Documents\', \'contact_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_USER_CONTACT_ID','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Documents\', \'portal_id\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_ID','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Documents\', \'portal_user_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_USER','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Documents\', \'created_from_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_FROM','module' => 'Documents','for_js' => true), $this);?>
<?php echo '\' );
