<?php /* Smarty version 2.6.31, created on 2019-02-13 04:59:15
         compiled from modules/AOR_Reports/Dashlets/AORReportsDashlet/dashletConfigure.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'modules/AOR_Reports/Dashlets/AORReportsDashlet/dashletConfigure.tpl', 168, false),)), $this); ?>
<div>
...
">
                            ...
                            <input type='hidden' name='parameter_id[<?php echo $this->_tpl_vars['condition']['key']; ?>
]' value='<?php echo $this->_tpl_vars['condition']['id']; ?>
'>
                            <input type='hidden' name='parameter_operator[<?php echo $this->_tpl_vars['condition']['key']; ?>
]' value='<?php echo $this->_tpl_vars['condition']['operator']; ?>
'>
                            <input type='hidden' name='parameter_type[<?php echo $this->_tpl_vars['condition']['key']; ?>
]' value='<?php echo $this->_tpl_vars['condition']['value_type']; ?>
'>
