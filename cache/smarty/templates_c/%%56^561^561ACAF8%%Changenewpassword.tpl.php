<?php /* Smarty version 2.6.31, created on 2019-01-29 15:59:42
         compiled from modules/Users/Changenewpassword.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/Users/Changenewpassword.tpl', 51, false),)), $this); ?>
<?php echo '
...
<td align="center">
		...
		<tr>
			<td colspan="2" width="100%" style="font-size: 12px; padding-bottom: 5px; font-weight: normal; color: red;"><?php echo $this->_tpl_vars['ERRORS']; ?>
</td>
		</tr>
...
:</td>
			<td width="30%">
				<input type="password" size="26" tabindex="2" id="new_password" name="new_password" value="" onkeyup="password_confirmation();newrules('<?php echo $this->_tpl_vars['PWDSETTINGS']['minpwdlength']; ?>
...
:</td>
			<td width="30%">
				<input type="password" size="26" tabindex="2" id="confirm_pwd" name="confirm_pwd" value="" onkeyup="password_confirmation();" /> <div id="comfirm_pwd_match" class="error" style="display: none;"><?php echo $this->_tpl_vars['MOD']['LBL_PASSWORD_MIS_MATCH']; ?>
</div></td>
		</tr>
		<tr>
