<?php /* Smarty version 2.6.31, created on 2019-02-18 19:07:13
         compiled from cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl', 66, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl', 83, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOK_KnowledgeBase/SearchForm_advanced.tpl', 164, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOK_KnowledgeBase'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'AOK_KnowledgeBase'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_author_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["author_advanced","user_id_c_advanced"],"required_list":["user_id_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_approver_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["approver_advanced","user_id1_c_advanced"],"required_list":["user_id1_c"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_aok_knowledgebase_aok_knowledge_base_categories_1_name_advanced\']={"form":"search_form","method":"query","modules":["AOK_Knowledge_Base_Categories"],"group":"or","field_list":["name","id"],"populate_list":["aok_knowledgebase_aok_knowledge_base_categories_1_name_advanced","aok_knowleec4eegories_idb_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_aok_knowledge_base_sub_cat_aok_knowledgebase_1_name_advanced\']={"form":"search_form","method":"query","modules":["AOK_Knowledge_Base_Sub_Cat"],"group":"or","field_list":["name","id"],"populate_list":["aok_knowledge_base_sub_cat_aok_knowledgebase_1_name_advanced","aok_knowle9facsub_cat_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>