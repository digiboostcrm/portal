<?php /* Smarty version 2.6.31, created on 2019-03-08 16:26:41
         compiled from cache/themes/SuiteP/modules/Leads/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 145, false),array('modifier', 'substr', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 444, false),array('modifier', 'to_url', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 446, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 486, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 486, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 486, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 497, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 80, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 89, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 152, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 269, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Leads/DetailView.tpl', 1501, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="varchar" field="title" colspan='3' >
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="lead_source_1_c"  >

<?php if (! $this->_tpl_vars['fields']['lead_source_1_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['lead_source_1_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lead_source_1_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lead_source_1_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['lead_source_1_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lead_source_1_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lead_source_1_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['lead_source_1_c']['options'][$this->_tpl_vars['fields']['lead_source_1_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="next_step_c"  >

<?php if (! $this->_tpl_vars['fields']['next_step_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['next_step_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['next_step_c']['value']; ?>
</span>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="lead_type"  >

<?php if (! $this->_tpl_vars['fields']['lead_type']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['lead_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lead_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lead_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['lead_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lead_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lead_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['lead_type']['options'][$this->_tpl_vars['fields']['lead_type']['value']]; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="varchar" field="tracking_number" colspan='3' >

<?php if (! $this->_tpl_vars['fields']['tracking_number']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tracking_number']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['tracking_number']['value']; ?>
</span>
<?php endif; ?>
...
<div class="panel-body panel-collapse collapse in panelContainer" id="top-panel-1"  data-id="LBL_PANEL_ASSIGNMENT">
<div class="tab-content">
<!-- TAB CONTENT -->
