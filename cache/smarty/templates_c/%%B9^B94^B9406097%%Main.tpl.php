<?php /* Smarty version 2.6.31, created on 2019-01-29 20:27:07
         compiled from modules/qbs_QBSugar/tpls/Main.tpl */ ?>
<input type="hidden" id = 'quickbooks_menu_url' value='<?php echo $this->_tpl_vars['quickbooks_menu_url']; ?>
'>
<input type="hidden" id = 'quickbooks_oauth_url' value='<?php echo $this->_tpl_vars['quickbooks_oauth_url']; ?>
'>
<?php echo '
<style>
#box-table-a {
...
<div class="row" style="position:relative;float:right;right:-10%;">
    ...
    <span style='text-decoration: underline;color:#F08377'><b> <?php echo $this->_tpl_vars['quickbooks_company_name']; ?>
</b> </span>
</div>

<form action="#" method="post" name="qbtigersettings">
<div class = "mainQBTiger">
	<div id = "MANUAL_SHOW" style = "display:<?php echo $this->_tpl_vars['manual_show']; ?>
;float:left;width:100%">  
		<div style = "display:<?php echo $this->_tpl_vars['manual_show']; ?>
;float:left;width:60%;" class = "edit search basic">
		<div class = 'widget_header row-fluid'>
	                <div class = 'span1'> 
				<img width="48" height="48" border="0" title="qbtiger" alt="qbtiger" src="modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/qbtiger.png" style="float:left;padding: 5px;"> 
			...
			<tr>
				<td width = "180"> 
                            <div class = 'sync-label' data-id = 'get_contacts' title=' Last Synced: <?php echo $this->_tpl_vars['last_synced']['Customer']; ?>
'> Get Contacts From QuickBooks </div>
				</td>
				<td width = "10">
					 <div id = "loadingImage_getContactsfromQB" class = "loadingGif" style = "float:right;"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div>
				</td>
				<td width = "30">
					<div id = "button_getContactsfromQB" style = "display:<?php echo $this->_tpl_vars['Customer']; ?>
">
					...
					<div id = "button_getContactsfromQB_delete" style = "display:<?php echo $this->_tpl_vars['Customer_delete']; ?>
">
			...
			<tr>
				<td width = "180"> 
                            <div class = 'sync-label' data-id = 'send_contacts' title='Last Synced: <?php echo $this->_tpl_vars['last_synced']['QBCustomer']; ?>
'> Send Contacts to QuickBooks </div>
				</td>
                                <td width = "10">
               		                 <div id = "loadingImage_sendContactstoQB" class = "loadingGif" style = "float:right;"><img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div>
				</td>
				<td width = "30">
					<div id = "button_sendContactstoQB" style = "display:<?php echo $this->_tpl_vars['QBCustomer']; ?>
"> 
					...
					<div id = "button_sendContactstoQB_delete" style = "display:<?php echo $this->_tpl_vars['QBCustomer_delete']; ?>
">
			...
			<tr>
				<td width = "180"> 
                            <div class = 'sync-label' data-id = 'get_invoice' title='Last Synced: <?php echo $this->_tpl_vars['last_synced']['Invoice']; ?>
'> Get Invoice From QuickBooks </div>

				</td>
				<td width = "10">
                                        <div id = "loadingImage_getInvoicefromQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading" > </div>
				</td>
				<td width = "30">
					<div id = "button_getInvoicefromQB" style = "display:<?php echo $this->_tpl_vars['Invoice']; ?>
"> 
					...
					<div id = "button_getInvoicefromQB_delete" style = "display:<?php echo $this->_tpl_vars['Invoice_delete']; ?>
">
			...
			<tr>
				<td width = "180"> 
                            <div class = 'sync-label' data-id = 'send_invoice' title='Last Synced: <?php echo $this->_tpl_vars['last_synced']['QBInvoice']; ?>
'> Send Invoice to QuickBooks </div>
				</td>
                                <td width = "10">
                	                <div id = "loadingImage_sendInvoicetoQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div>
                                </td>
				<td width = "30">
					<div id = "button_sendInvoicetoQB" style = "display:<?php echo $this->_tpl_vars['QBInvoice']; ?>
"> 
					...
					<div id = "button_sendInvoicetoQB_delete" style = "display:<?php echo $this->_tpl_vars['QBInvoice_delete']; ?>
">
			...
			<tr>
				<td width = "180"> 
                            <div class = 'sync-label' data-id = 'get_SalesOrder' title='Last Synced: <?php echo $this->_tpl_vars['last_synced']['SalesOrder']; ?>
'> Get SalesRecipt From QuickBooks </div>

				</td>
				<td width = "10">
                                        <div id = "loadingImage_getSalesOrderfromQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading" > </div>
				</td>
				<td width = "30">
					<div id = "button_getSalesOrderfromQB" style = "display:<?php echo $this->_tpl_vars['SalesOrder']; ?>
"> 
					...
					<div id = "button_getSalesOrderfromQB_delete" style = "display:<?php echo $this->_tpl_vars['SalesOrder_delete']; ?>
">
			...
			<tr>
                                <td width = "180">
                            <div class = 'sync-label' data-id = 'get_quotes' title=' Last Synced: <?php echo $this->_tpl_vars['last_synced']['Quotes']; ?>
'> Get Quotes From QuickBooks </div>

                                </td>
			         <td width = "10">
         	                        <div id = "loadingImage_getQuotesfromQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading" > </div>
                                 </td>
                                 <td width = "30">
					<div id = "button_getQuotesfromQB" style = "display:<?php echo $this->_tpl_vars['Quotes']; ?>
">
					...
					<div id = "button_getQuotesfromQB_delete" style = "display:<?php echo $this->_tpl_vars['Quotes_delete']; ?>
">
                          ...
                          <tr>
                                  <td width = "180">
                            <div class = 'sync-label' data-id = 'send_quotes' title=' Last Synced: <?php echo $this->_tpl_vars['last_synced']['QBQuotes']; ?>
'> Send Quotes to QuickBooks </div>
                                  </td>
				<td width = "10">
        	                        <div id = "loadingImage_sendQuotestoQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div>
                                </td>
                                <td width = "30">
					<div id = "button_sendQuotestoQB" style = "display:<?php echo $this->_tpl_vars['QBQuotes']; ?>
"> 
					...
					<div id = "button_sendQuotestoQB_delete" style = "display:<?php echo $this->_tpl_vars['QBQuotes_delete']; ?>
">
	 		...
	 		<tr>
					<td width = "180"> 
                            <div class = 'sync-label' data-id = 'get_item' title='Last Synced: <?php echo $this->_tpl_vars['last_synced']['Item']; ?>
'> Get Products From QuickBooks </div>
					</td>
                                        <td width = "10">
                                                <div id = "loadingImage_getProductsfromQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div>
                                        </td>
					<td width = "30"> 
					<div id = "button_getProductsfromQB" style = "display:<?php echo $this->_tpl_vars['Item']; ?>
"> 
					...
					<div id = "button_getProductsfromQB_delete" style = "display:<?php echo $this->_tpl_vars['Item_delete']; ?>
">
			...
			<tr>
					<td width = "180"> 
                            <div class = 'sync-label' data-id = 'send_item' title='Last Synced: <?php echo $this->_tpl_vars['last_synced']['QBItem']; ?>
'> Send Products to QuickBooks </div>
					</td>
					<td width = "10">
						<div id = "loadingImage_sendProductstoQB" class = "loadingGif"> <img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div>
					</td>
					<td width = "30">
					<div id = "button_sendProductstoQB" style = "display:<?php echo $this->_tpl_vars['QBItem']; ?>
"> 
					...
					<div id = "button_sendProductstoQB_delete" style = "display:<?php echo $this->_tpl_vars['QBItem_delete']; ?>
">
...
<br/>
	...
	<div id = "API_SHOW" style = "display:<?php echo $this->_tpl_vars['api_show']; ?>
;float:left;width:800px;padding-left:20px;" > <br>
		<div class = 'widget_header row-fluid'>
                	<div class = 'span1'> <img width="48" height="48" border="0" title="qbtiger" alt="qbtiger" src="modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/qbtiger.png"> </div>
                ...
                <table border=0 cellspacing=0 cellpadding=5 width=100% class="table table-bordered table-condensed listViewEntriesTable">
                        <tr>
                                ...
                                <?php if ($this->_tpl_vars['MODE'] == 'EDIT'): ?>
                                       <td class = "small cellText" width = "70%"> <input type = "text" name = "app_token" id = "app_token" value = "<?php echo $this->_tpl_vars['APP_TOKEN']; ?>
" class="input-xlarge" style = 'width:320px;'> </td>
                                <?php else: ?>
                                        <td class="small cellText" width="70%"> <?php echo $this->_tpl_vars['APP_TOKEN']; ?>
 </td>
                                <?php endif; ?>
                        </tr>
                        <tr>
                                ...
                                <?php if ($this->_tpl_vars['MODE'] == 'EDIT'): ?>
                                       <td class = "small cellText" width = "70%"> <input type = "text" name = "consumer_key" id = "consumer_key" value = "<?php echo $this->_tpl_vars['CONSUMER_KEY']; ?>
" class="input-xlarge" style = 'width:320px;'> </td>
                                <?php else: ?>
                                        <td class="small cellText" width="70%"> <?php echo $this->_tpl_vars['CONSUMER_KEY']; ?>
 </td>
                                <?php endif; ?>
                        </tr>
                        <tr>
                                ...
                                <?php if ($this->_tpl_vars['MODE'] == 'EDIT'): ?>
                                       <td class = "small cellText" width = "70%"> <input type = "text" name = "consumer_secret" id = "consumer_secret" value = "<?php echo $this->_tpl_vars['CONSUMER_SECRET']; ?>
" class = "input-xlarge" style = 'width:320px;'> </td>
                                <?php else: ?>
                                        <td class="small cellText" width="70%"> <?php echo $this->_tpl_vars['CONSUMER_SECRET']; ?>
 </td>
                                <?php endif; ?>
                        </tr>
                        <tr>
				       ...
				       <td class="small cellText" width="70%">
				       		<input type = "radio" name = "service" id = "Cron" onclick="tooglecron(this.id);" value = "Cron" <?php if ($this->_tpl_vars['SERVICE'] == 'Cron'): ?> checked  <?php endif; ?> > Cron
				       		<input type = "radio" name = "service" id = "Oncreate" onclick="tooglecron(this.id);" value = "OnCreate"  <?php if ($this->_tpl_vars['SERVICE'] == 'OnCreate'): ?> checked  <?php endif; ?>> OnCreate
					</td>
                                <?php else: ?>
                                        <td class="small cellText" width="70%"> <?php echo $this->_tpl_vars['SERVICE']; ?>
 </td>
                                <?php endif; ?>
                        </tr>
			<tr>
                                ...
                                <?php if ($this->_tpl_vars['MODE'] == 'EDIT'): ?>
                                       <td class="small cellText" width="70%">
                                                <input type = "radio" name = "duplicate_handling" id = "skip" value = "Skip" <?php if ($this->_tpl_vars['DUPLICATE_HANDLING'] == 'Skip'): ?> checked  <?php endif; ?> > Skip
                                                <input type = "radio" name = "duplicate_handling" id = "addsuffix" value = "Add Suffix"  <?php if ($this->_tpl_vars['DUPLICATE_HANDLING'] == 'Add Suffix'): ?> checked  <?php endif; ?>> Add Suffix
                                        </td>
                                <?php else: ?>
                                        <td class="small cellText" width="70%"> <?php echo $this->_tpl_vars['DUPLICATE_HANDLING']; ?>
 </td>
                                <?php endif; ?>
		...
		<div> 
			...
			<div id = "loadingImage_resetQBTiger" class = "loadingGif" style = "float:left"><img src = "modules/<?php echo $this->_tpl_vars['currentModule']; ?>
/images/loading.gif" alt = "Loading"> </div> 
