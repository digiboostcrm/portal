<?php /* Smarty version 2.6.31, created on 2019-01-30 19:45:21
         compiled from cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 127, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 643, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 724, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/AOS_Contracts/SearchForm_advanced.tpl', 141, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='contract_account_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTRACT_ACCOUNT','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['contract_account_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['contract_account_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"contract_account_id_advanced","name":"contract_account_advanced"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['contract_account_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['contract_account_id_advanced']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='opportunity_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITY','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['opportunity_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['opportunity_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"opportunity_id_advanced","name":"opportunity_advanced"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['opportunity_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['opportunity_id_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='start_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='end_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_END_DATE','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='total_contract_value_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TOTAL_CONTRACT_VALUE','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['total_contract_value_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['total_contract_value_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['total_contract_value_advanced']['value']); ?>
<?php endif; ?>

<?php $this->assign('id', $this->_tpl_vars['fields']['total_contract_value_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['total_contract_value_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['total_contract_value_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['total_contract_value_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>
...
' style='width:75px !important;' size='20' 
    ...
    value='<?php if (empty ( $_REQUEST['range_total_contract_value_advanced'] ) && ! empty ( $_REQUEST['total_contract_value_advanced'] )): ?><?php echo $_REQUEST['total_contract_value_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_total_contract_value_advanced']; ?>
<?php endif; ?>' tabindex='' >
</div>
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
...
' style='width:75px !important;' size='10' 
    ...
    value='<?php echo $_REQUEST['start_range_total_contract_value_advanced']; ?>
' tabindex=''>
<?php echo $this->_tpl_vars['APP']['LBL_AND']; ?>
...
' style='width:75px !important;' size='10' 
    ...
    value='<?php echo $_REQUEST['end_range_total_contract_value_advanced']; ?>
' tabindex=''>    
</div> 
</span>
                            </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='contract_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTRACT_TYPE','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'contract_type_advanced','name' => 'contract_type_advanced[]','options' => $this->_tpl_vars['fields']['contract_type_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['contract_type_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'AOS_Contracts'), $this);?>
</label>
                            </div>
            <div class="form-item">
