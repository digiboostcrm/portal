<?php /* Smarty version 2.6.31, created on 2019-02-01 23:01:53
         compiled from cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl', 150, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl', 167, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_popup_query_form.tpl', 248, false),)), $this); ?>
...
' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='part_number_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PART_NUMBER','module' => 'AOS_Products'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['part_number_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['part_number_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['part_number_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['part_number_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['part_number_advanced']['name']; ?>
' size='30' 
    maxlength='25' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='cost_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_COST','module' => 'AOS_Products'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['cost_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['cost_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['cost_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['cost_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['cost_advanced']['name']; ?>
' size='30' 
...
' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_by_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOS_Products'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'created_by_advanced','name' => 'created_by_advanced[]','options' => $this->_tpl_vars['fields']['created_by_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['created_by_advanced']['value']), $this);?>
