<?php /* Smarty version 2.6.31, created on 2019-03-08 16:21:06
         compiled from cache/themes/SuiteP/modules/Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 47, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 56, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 147, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 225, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 369, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 140, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 477, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 477, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 477, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 488, false),)), $this); ?>
...
"/>
<?php if (empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED']): ?><input title="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_PORTAL_USER']; ?>
...
"/><?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 1): ?><input title="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PORTAL_USER']; ?>
" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='resetPortalUser';_form.submit();" name="buttonResetPortalUser" id="resetPortalUser_button" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PORTAL_USER']; ?>
"/><?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 1): ?><input title="Portal Auto Login" class="button" onclick="autoLogin('<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
')" name="buttonPortalAutoLogin" id="portalAutoLogin_button" type="button" value="Portal Auto Login"/><?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 0): ?><input title="Enable Portal Login" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='enablePortalUser';_form.submit();" name="buttonPortalEnableUser" id="portalEnableUser_button" type="button" value="Enable Portal Login"/><?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 1): ?><input title="Disable Portal Login" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='disablePortalUser';_form.submit();" name="buttonPortalDisableUser" id="portalDisableUser_button" type="button" value="Disable Portal Login"/><?php endif; ?>
...
"/></li>
<li><?php if (empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED']): ?><input title="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_PORTAL_USER']; ?>
" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='createPortalUser';_form.submit();" name="buttonCreatePortalUser" id="createPortalUser_button" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_PORTAL_USER']; ?>
"/><?php endif; ?></li>
<li><?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 1): ?><input title="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PORTAL_USER']; ?>
" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='resetPortalUser';_form.submit();" name="buttonResetPortalUser" id="resetPortalUser_button" type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_RESET_PORTAL_USER']; ?>
"/><?php endif; ?></li>
<li><?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 1): ?><input title="Portal Auto Login" class="button" onclick="autoLogin('<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
')" name="buttonPortalAutoLogin" id="portalAutoLogin_button" type="button" value="Portal Auto Login"/><?php endif; ?></li>
<li><?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 0): ?><input title="Enable Portal Login" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='enablePortalUser';_form.submit();" name="buttonPortalEnableUser" id="portalEnableUser_button" type="button" value="Enable Portal Login"/><?php endif; ?></li>
<li><?php if (! empty ( $this->_tpl_vars['fields']['username_c']['value'] ) && $this->_tpl_vars['AOP_PORTAL_ENABLED'] && $this->_tpl_vars['fields']['enable_portal_c']['value'] == 1): ?><input title="Disable Portal Login" class="button" onclick="var _form = document.getElementById('formDetailView');_form.action.value='disablePortalUser';_form.submit();" name="buttonPortalDisableUser" id="portalDisableUser_button" type="button" value="Disable Portal Login"/><?php endif; ?></li>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BC_USER_GROUP_CONTACTS_FROM_BC_USER_GROUP_TITLE','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="bc_user_group_contacts_name"  >

<?php if (! $this->_tpl_vars['fields']['bc_user_group_contacts_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['bc_user_group_contactsbc_user_group_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=bc_user_group&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['bc_user_group_contactsbc_user_group_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="bc_user_group_contactsbc_user_group_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['bc_user_group_contactsbc_user_group_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['bc_user_group_contacts_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['bc_user_group_contactsbc_user_group_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUGARQUICKBOOKS','module' => 'Contacts'), $this);?>

</div>
</a>
</div>
<div class="panel-body panel-collapse collapse in panelContainer" id="top-panel-2"  data-id="LBL_SUGARQUICKBOOKS">
<div class="tab-content">
<!-- TAB CONTENT -->
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QB_CREATED_TIME','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="datetime" field="qbcreatedtime_c"  >

<?php if (! $this->_tpl_vars['fields']['qbcreatedtime_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php $this->assign('value', "09/03/2018"); ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['qbcreatedtime_c']['name']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QB_MODIFIED_TIME','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="datetime" field="qbmodifiedtime_c"  >

<?php if (! $this->_tpl_vars['fields']['qbmodifiedtime_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php $this->assign('value', "03/07/2019"); ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['qbmodifiedtime_c']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_QBID','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="varchar" field="qbid_c" colspan='3' >

<?php if (! $this->_tpl_vars['fields']['qbid_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['qbid_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['qbid_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['qbid_c']['value']); ?>
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['qbid_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['qbid_c']['value']; ?>
</span>
<?php endif; ?>
