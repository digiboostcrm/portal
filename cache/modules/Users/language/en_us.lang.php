...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'ERR_USER_IS_LOCKED_OUT' => 'This user is locked out of the Digiboost application and cannot log in using his/her existing password.',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Digiboost Mail Client:</b> Send emails using the email client in the Digiboost application.<br><b>External Mail Client:</b> Send email using an email client outside of the Digiboost application, such as Microsoft Outlook.',
  ...
  'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email). This type cannot login through the Digiboost web interface.',
  ...
  'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the Digiboost web interface.',
  ...
  'LBL_REMINDER_TEXT' => 'Set a default for reminders for calls and meetings. Pop-up notifications appear for all invitees using Digiboost. Email reminders are sent to all invitees.',
  ...
  'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the Digiboost Plug-in for Microsoft&reg; Outlook&reg; and the Digiboost Plug-in for Microsoft&reg; Word&reg;.',
  ...
  'LBL_SUGAR_LOGIN' => 'Is Digiboost User',
  'LBL_THEME' => 'Themes',
  ...
  'LBL_ICAL_PUB_URL_HELP' => 'Use this URL to subscribe to the Digiboost calendar within iCal.',
  ...
  'LBL_WIZARD_WELCOME_TITLE' => 'Welcome to Digiboost!',
  'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using Digiboost.',
  'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using Digiboost.',
  'LBL_WIZARD_NEXT_BUTTON' => 'Next >',
  'LBL_WIZARD_BACK_BUTTON' => '< Back',
  'LBL_WIZARD_SKIP_BUTTON' => 'Skip',
  'LBL_WIZARD_FINISH_BUTTON' => 'Finish',
  'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use Digiboost!',
...
<img src=include/images/suitecrm_login.png style="margin-right: 5px;">
  ...
  'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in Digiboost.',
  ...
  'LBL_ADD_DASHLETS' => 'Add Digiboost Dashlets',
  ...
  'LBL_TEST_EMAIL_SUBJECT' => 'Test Email from Digiboost',
  'LBL_NO_SUBJECT' => '(no subject)',
  'LBL_CHECKING_ACCOUNT' => 'Checking Account',
  'LBL_OF' => 'of',
  'LBL_TEST_EMAIL_BODY' => 'This email was sent in order to test the outgoing mail server information provided in the Digiboost application. A successful receipt of this email indicates that the outgoing mail server information provided is valid.',
  ...
  'LBL_SUITE_SUPERCHARGED' => 'Supercharged by Digiboost',
  'LBL_SUITE_POWERED_BY' => 'Powered By Digiboost',
  'LBL_SUITE_TOP' => 'Back to top',
  'LBL_SUITE_DESC1' => 'Digiboost has been written and assembled by <a href="https://salesagility.com">SalesAgility</a>. The Program is provided AS IS, without warranty. Licensed under AGPLv3.',
  ...
  'LBL_SUITE_DESC3' => 'Digiboost is a trademark of SalesAgility Ltd. All other company and product names may be trademarks of the respective companies with which they are associated.',
  'LBL_RLS_RLS_SCHEDULING_REPORTS_USERS_FROM_RLS_RLS_SCHEDULING_REPORTS_TITLE' => 'Scheduling Reports',
  'LBL_RLS_SCHEDULING_REPORTS_USERS_FROM_RLS_SCHEDULING_REPORTS_TITLE' => 'Scheduling Reports',
  'LBL_NOTIFICATION_MODULE_INFORMATION' => 'Desktop Notification Modules',
);