...
$mod_strings = array (
  ...
  'ERR_CREDENTIALS_MISSING' => 'Your Digiboost credentials are missing.',
...
',
  ...
  'ERROR_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Digiboost: ',
  'HDR_LOGIN_PANEL' => 'Please enter your Digiboost Login credentials.',
  'HEARTBEAT_MESSAGE' => '<BR>The Digiboost Updates mechanism allows your server to check to see if an update for your version of Digiboost is available.',
  ...
  'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by Digiboost',
  ...
  'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the Digiboost application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
  'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your Digiboost application files in a .zip file, enter the following information:',
  'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
  'LBL_BACKUPS_TITLE' => 'Backups',
  'LBL_BACKUPS' => 'Backup Digiboost files',
  'LBL_BUG_TITLE' => 'Bugs',
  ...
  'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the Digiboost Server.
  ...
  'LBL_DIAGNOSTIC_CONFIGPHP' => 'Digiboost config.php',
  'LBL_DIAGNOSTIC_CUSTOMDIR' => 'Digiboost Custom directory',
  ...
  'LBL_DIAGNOSTIC_SUGARLOG' => 'Digiboost Log File',
  'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
  'LBL_DIAGNOSTIC_VARDEFS' => 'Digiboost schema output (VARDEFS)',
  ...
  'LBL_EXPORT_CUSTOM_FIELDS' => 'Export custom field definitions to a .Digiboost file',
  ...
  'LBL_IMPORT_CUSTOM_FIELDS' => 'Import custom field definitions from a .Digiboost file',
  ...
  'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the Digiboost Password Management feature settings will apply.',
  'LBL_LDAP_SERVER_HOSTNAME' => 'Server:',
  'LBL_LDAP_SERVER_PORT' => 'Port Number:',
  'LBL_LDAP_ADMIN_USER' => 'User Name:',
  'LBL_LDAP_ADMIN_USER_DESC' => 'Used to search for the Digiboost user. [May need to be fully qualified] It will bind anonymously if not provided.',
  ...
  'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=Digiboost',
  'LBL_LDAP_USER_DN_DESC' => 'Example: ou=people,dc=example,dc=com',
  'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist, one will be created in Digiboost.',
  ...
  'LBL_MI_IN_DASHLETS' => 'Installing Digiboost Dashlet ',
  'LBL_MI_UN_DASHLETS' => 'Uninstalling Digiboost Dashlet ',
  ...
  'LBL_MODULE_LOADER' => 'Add or remove Digiboost modules, themes, language packs and other extensions',
  ...
  'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as Digiboost updates.',
  ...
  'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the Digiboost Dashlets cache file',
  'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'Digiboost Dashlets cache file rebuilt.',
  'LBL_REBUILD_DASHLETS_DESC' => 'Removing Digiboost Dashlets cache and scanning known directories for Digiboost Dashlet files.',
  'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild Digiboost Dashlets',
  ...
  'LBL_RETURN' => 'Return',
  'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to Digiboost. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
  ...
  'LBL_SUGAR_UPDATE_TITLE' => 'Digiboost Updates',
  ...
  'LBL_UPDATE_TITLE' => 'Digiboost Updates',
  'LBL_UPGRADE_TITLE' => 'Repair',
  'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
  'LBL_UPGRADE_WIZARD' => 'Upload and install Digiboost upgrades',
  'LBL_UPGRADE' => 'Check and repair Digiboost',
  ...
  'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in Digiboost.',
...
',
  ...
  'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of Digiboost',
  'LBL_SUGARPORTAL' => 'Digiboost Portal',
  ...
  'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, Digiboost Dashlets etc.',
  ...
  'LBL_QR_CBOX_CLEARDASHLET' => 'Clear Digiboost Dashlet Cache Data',
  ...
  'LBL_QR_CLEARDASHLET' => 'Clearing Digiboost Dashlet files from cache...done',
  ...
  'LBL_QR_CBOX_CLEARSUGARFEEDCACHE' => 'Clear Digiboost Feed Cache',
  'LBL_QR_CLEARSUGARFEEDCACHE' => 'Clearing Digiboost Feed Cache...done',
...
',
  ...
  'ML_RELAX_LOCAL' => 'If you are running Digiboost locally, you can relax your Module Loader restrictions to allow the package to be installed.',
  'ML_SUGAR_KB' => 'Digiboost Knowledge Base',
  'ML_SUGAR_DZ' => 'Digiboost Developer Zone',
  'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
  'ML_OVERRIDE_CORE_FILES' => 'Overriding of core Digiboost files is not allowed ',
  ...
  'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the Digiboost Password Management feature settings will apply.',
  ...
  'LBL_MANAGE_SECURITYGROUPS_TITLE' => 'Security Digiboost Group Management',
  'LBL_MANAGE_SECURITYGROUPS' => 'Security Digiboost Group Editor',
  'LBL_CONFIG_SECURITYGROUPS_TITLE' => 'Security Digiboost Settings',
  'LBL_CONFIG_SECURITYGROUPS' => 'Configure Security Digiboost settings such as group inheritance, additive security, etc',
  ...
  'ERROR_FLAVOR_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Digiboost: ',
  'LBL_SUGARCRM_HELP' => 'Digiboost Help',
  'LBL_SUPPORT_TITLE' => 'Digiboost Support Portal',
  'LBL_ADMIN_MODULE_NAME' => 'Administration',
  'LBL_PORTAL_CONFIGURE_MODULE_LINK' => 'Configure Portal Layout',
  'LBL_PORTAL_CONFIGURE_MODULE_LINK_DESC' => 'Set Portal Layouts.',
  'LBL_PORTAL_DESC' => 'Configure Portal Layout for modules',
  'LBL_PORTAL_TITLE' => 'Configure Portal layout',
  'LBL_PORTAL_CONF_TITLE' => 'Customer Portal',
  'LBL_PORTAL_CONF_DESC' => 'Validate license and module configuration and set portal layout.',
  'LBL_PORTAL_CONF_LINK' => 'License Configuration',
  'LBL_PORTAL_CONF_LINK_DESC' => 'Manage and configure the license for Customer Portal add-on.',
  'LBL_WP_USER_GROUP' => 'Customer Portal User Group',
  'LBL_WP_USER_GROUP_DESC' => 'Customer Portal User Group Configuration',
  ...
  'LBL_DEFAULT' => 'default',
  'LBL_OTHER' => 'Other',
  'LBL_EXPORT_PORTAL_CONTACTS_CSV' => 'Export Portal Contacts in CSV',
  'LBL_EXPORT_PORTAL_CONTACTS' => 'Export Portal Contacts',
  'LBL_LINK_NAME_P' => 'Payment Configuration',
  'LBL_LINK_DESCRIPTION_P' => 'Setting for payment configuration.',
  'LNK_LABLE_STATUS_ENABLE_DISABLE' => 'Payment Enable/Disable',
  'LNK_MODULE_FEILDS' => 'Payment Module and Fields',
  'LNK_STATUS_MODULE_FEILDS' => 'Payment Status Module and Fields',
  'LBL_LINK_NAME_GENERAL_CONFIG' => 'General Portal Configuration',
  'LBL_LINK_NAME_CHAT_CONFIG' => 'Chat Configuration',
  'LBL_LINK_DESCRIPTION_CHAT_CONFIG' => 'Chat Configuration for portal',
  'LBL_LINK_DESCRIPTION_GENERAL_CONFIG' => 'Chat Configuration , Email Templates Configuration And Chart Configuration for portal',
  'LBL_PORTAL_SIGNUP' => 'Portal Signup',
  'LBL_EMAIL_TEMPLATE_CONFIG' => 'Email Template Configuration',
  'LBL_Email_TEMPLATE_DESCRIPTION_CONFIG' => 'Set Email Templates',
  'LBL_LEAD_DETAILS' => 'Lead Details',
  'LBL_CALL_DETAILS' => 'Call Details',
  ...
  'LBL_OPPORTUNITY_DETAILS' => 'Opportunity Details',
  'LBL_ACCOUNT_DETAILS' => 'Account Details',
  'LBL_DOCUMENT_DETAILS' => 'Document Details',
  'LBL_QUOTE_DETAILS' => 'Quote Details',
  'LBL_INVOICE_DETAILS' => 'Invoice Details',
  'LBL_CONTRACT_DETAILS' => 'Contract Details',
  'LBL_NOTIFICATION_CONFIGURE_MODULE_LINK' => 'Configure Notification Modules',
  'LBL_NOTIFICATION_CONFIGURE_MODULE_LINK_DESC' => 'Enable/Disable modules for Desktop Notification.',
  'LBL_NOTIFICATION_DESC' => 'Configure which modules are available to users for Desktop Notification.',
  'LBL_NOTIFICATION_TITLE' => 'Desktop Notification',
  'LBL_REPORTLICENSEADDON' => 'License Add-on',
  'LBL_REPORTLICENSEADDON_LICENSE_TITLE' => 'Reports Module License Configuration',
  'LBL_REPORTLICENSEADDON_LICENSE' => 'Manage and configure license for <a href="http://www.richlodesolutions.com" target="_blank">Richlode Solutions</a> Reports add-on. ',
  'LBL_MANAGE_REPORT_CONFIG' => 'Reports parameters',
  'LBL_REPORT_CONFIG' => 'Set reports parameters',
  'LBL_REPORT_CONFIG_DESC' => 'Configure reports parameters',
  'LBL_REPORT_CONFIG_TITLE' => 'Reports',
  'LBL_qbs_QBSugar' => 'Quickbooks SuiteCRM Add-on',
  'LBL_qbs_QBSugar_LICENSE_TITLE' => 'License Configuration',
  'LBL_qbs_QBSugar_LICENSE' => 'Manage and configure the license for this add-on',
  'LBL_MULTIUPLOAD' => 'Multiupload Add-on',
  'LBL_MULTIUPLOAD_LICENSE_TITLE' => 'License Configuration',
  'LBL_MULTIUPLOAD_LICENSE' => 'Manage and configure the license for this add-on',
);