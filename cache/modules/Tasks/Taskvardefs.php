<?php 
 $GLOBALS["dictionary"]["Task"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '',
      'labelValue' => 'RightSignature',
      'required' => false,
      'source' => 'non-db',
      'name' => 'rightsignature_c',
      'vname' => 'LBL_RIGHTSIGNATURE',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'ut_rightsignature_id_c',
      'ext2' => 'UT_RightSignature',
      'module' => 'UT_RightSignature',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Tasksrightsignature_c',
      'custom_module' => 'Tasks',
    ),
    'ut_rightsignature_id_c' => 
    array (
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'ut_rightsignature_id_c',
      'vname' => 'LBL_RIGHTSIGNATURE_UT_RIGHTSIGNATURE_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Tasksut_rightsignature_id_c',
      'custom_module' => 'Tasks',
    ),
  ),
  'relationships' => 
