...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_RIGHTSIGNATURE' module='Tasks'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.rightsignature_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.rightsignature_c.name}" size="" value="{$fields.rightsignature_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.rightsignature_c.id_name}" 
id="{$fields.rightsignature_c.id_name}" 
value="{$fields.ut_rightsignature_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.rightsignature_c.name}" id="btn_{$fields.rightsignature_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.rightsignature_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"ut_rightsignature_id_c","name":"rightsignature_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.rightsignature_c.name}" id="btn_clr_{$fields.rightsignature_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.rightsignature_c.name}', '{$fields.rightsignature_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.rightsignature_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'parent_type', 'parent_type', false,'{/literal}{sugar_translate label='LBL_PARENT_TYPE' module='Tasks' for_js=true}{literal}' );
...
addToValidate('EditView', 'rightsignature_c', 'relate', false,'{/literal}{sugar_translate label='LBL_RIGHTSIGNATURE' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'ut_rightsignature_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_RIGHTSIGNATURE_UT_RIGHTSIGNATURE_ID' module='Tasks' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'contact_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CONTACT_NAME' module='Tasks' for_js=true}{literal}', 'contact_id' );
addToValidateBinaryDependency('EditView', 'rightsignature_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_RIGHTSIGNATURE' module='Tasks' for_js=true}{literal}', 'ut_rightsignature_id_c' );
