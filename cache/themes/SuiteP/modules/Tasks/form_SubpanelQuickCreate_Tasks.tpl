...
<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="Tasks_subpanel_cancel_button" id="Tasks_subpanel_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
...
{sugar_translate label='DEFAULT' module='Tasks'}
</div>
</a>
</div>
...
addToValidate('form_SubpanelQuickCreate_Tasks', 'rightsignature_c', 'relate', false,'{/literal}{sugar_translate label='LBL_RIGHTSIGNATURE' module='Tasks' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'ut_rightsignature_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_RIGHTSIGNATURE_UT_RIGHTSIGNATURE_ID' module='Tasks' for_js=true}{literal}' );
