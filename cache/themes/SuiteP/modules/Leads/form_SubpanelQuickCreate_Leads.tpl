...
{if $bean->aclAccess("save")}<input title="{$APP.LBL_SAVE_BUTTON_TITLE}"  class="button" onclick="var _form = (this.form) ? this.form : document.forms[0]; disableOnUnloadEditView(); _form.action.value='Save';if(check_form('form_SubpanelQuickCreate_Leads'))return SUGAR.subpanelUtils.inlineSave(_form.id, 'Leads_subpanel_save_button');return false;" type="submit" name="Leads_subpanel_save_button" id="Leads_subpanel_save_button" value="{$APP.LBL_SAVE_BUTTON_LABEL}">{/if} 
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="next_step_c" colspan='3' >
{counter name="panelFieldCount" print=false}
...
<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="Leads_subpanel_cancel_button" id="Leads_subpanel_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
<input title="{$APP.LBL_FULL_FORM_BUTTON_TITLE}" class="button" onclick="var _form = document.getElementById('form_SubpanelQuickCreate_Leads'); disableOnUnloadEditView(_form); _form.return_action.value='DetailView'; _form.action.value='EditView'; if(typeof(_form.to_pdf)!='undefined') _form.to_pdf.value='0';" type="submit" name="Leads_subpanel_full_form_button" id="Leads_subpanel_full_form_button" value="{$APP.LBL_FULL_FORM_BUTTON_LABEL}"> <input type="hidden" name="full_form" value="full_form">
{if $showVCRControl}
...
addToValidate('form_SubpanelQuickCreate_Leads', 'lawful_basis', 'multienum', false,'{/literal}{sugar_translate label='LBL_LAWFUL_BASIS' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'date_reviewed', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_REVIEWED' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'lawful_basis_source', 'enum', false,'{/literal}{sugar_translate label='LBL_LAWFUL_BASIS_SOURCE' module='Leads' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Leads', 'lead_source', 'enum', true,'{/literal}{sugar_translate label='LBL_LEAD_SOURCE' module='Leads' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Leads', 'sdr', 'enum', true,'{/literal}{sugar_translate label='LBL_SDR' module='Leads' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Leads', 'contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACT_LEAD_CONTACT_ID' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'lead_source_1_c', 'enum', true,'{/literal}{sugar_translate label='LBL_LEAD_SOURCE_1' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'tracking_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_TRACKING_NUMBER' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'next_step_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NEXT_STEP' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'contact_lead_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACT_LEAD' module='Leads' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Leads', 'lead_type', 'enum', true,'{/literal}{sugar_translate label='LBL_LEAD_TYPE' module='Leads' for_js=true}{literal}' );
...
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['form_SubpanelQuickCreate_Leads_assigned_user_name']={"form":"form_SubpanelQuickCreate_Leads","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>{/literal}
