...
{if !$fields.lead_source_1_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.lead_source_1_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.lead_source_1_c.name}" value="{ $fields.lead_source_1_c.options }">
{ $fields.lead_source_1_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.lead_source_1_c.name}" value="{ $fields.lead_source_1_c.value }">
{ $fields.lead_source_1_c.options[$fields.lead_source_1_c.value]}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.next_step_c.name}">{$fields.next_step_c.value}</span>
{/if}
...
{if !$fields.tracking_number.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.tracking_number.name}">{$fields.tracking_number.value}</span>
{/if}
