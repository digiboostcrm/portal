...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SDR' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.sdr.name}" 
id="{$fields.sdr.name}" 
title=''       
>
{if isset($fields.sdr.value) && $fields.sdr.value != ''}
{html_options options=$fields.sdr.options selected=$fields.sdr.value}
{else}
{html_options options=$fields.sdr.options selected=$fields.sdr.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.sdr.options }
{capture name="field_val"}{$fields.sdr.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.sdr.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.sdr.name}" 
id="{$fields.sdr.name}" 
title=''          
>
{if isset($fields.sdr.value) && $fields.sdr.value != ''}
...
<input
id="{$fields.sdr.name}-input"
name="{$fields.sdr.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.sdr.name}-image"></button><button type="button"
id="btn-clear-{$fields.sdr.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.sdr.name}-input', '{$fields.sdr.name}');sync_{$fields.sdr.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.sdr.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.sdr.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.sdr.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.sdr.name}');
			...
			//global variable 
			sync_{/literal}{$fields.sdr.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.sdr.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.sdr.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OPP_OWNER' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.opp_owner_c.name}"
id="{$fields.opp_owner_c.name}"
title='Select the Opp owner'           
>
{if isset($fields.opp_owner_c.value) && $fields.opp_owner_c.value != ''}
{html_options options=$fields.opp_owner_c.options selected=$fields.opp_owner_c.value}
{else}
{html_options options=$fields.opp_owner_c.options selected=$fields.opp_owner_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.opp_owner_c.options }
{capture name="field_val"}{$fields.opp_owner_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.opp_owner_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.opp_owner_c.name}"
id="{$fields.opp_owner_c.name}"
title='Select the Opp owner'          
>
{if isset($fields.opp_owner_c.value) && $fields.opp_owner_c.value != ''}
...
<input
id="{$fields.opp_owner_c.name}-input"
name="{$fields.opp_owner_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.opp_owner_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.opp_owner_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.opp_owner_c.name}-input', '{$fields.opp_owner_c.name}');sync_{$fields.opp_owner_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
    var selectElem = document.getElementById("{/literal}{$fields.opp_owner_c.name}{literal}");
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
    ...
    SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.opp_owner_c.name}-input');
    SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.opp_owner_c.name}-image');
    SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.opp_owner_c.name}');
    ...
    //global variable
    sync_{/literal}{$fields.opp_owner_c.name}{literal} = function(){
        SyncToHidden();
    }
    function syncFromHiddenToWidget(){
        ...
        for (i=0;i<selectElem.options.length;i++){
            ...
            if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.opp_owner_c.name}-input{literal}'))
                SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
        }
    }

    YAHOO.util.Event.onAvailable("{/literal}{$fields.opp_owner_c.name}{literal}", syncFromHiddenToWidget);
    {/literal}
...
<script type="text/javascript">
    ...
    addLoadEvent(function(){literal}{loadDynamicEnum({/literal}"","{$fields.opp_owner_c.name}"{literal})}{/literal});
    if (SUGAR.ajaxUI && SUGAR.ajaxUI.hist_loaded) {literal}{loadDynamicEnum({/literal}"","{$fields.opp_owner_c.name}"{literal})}{/literal}
</script>
</div>
