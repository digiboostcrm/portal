...
<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate($(this).attr('id'));return false;" type="submit" name="Opportunities_subpanel_cancel_button" id="Opportunities_subpanel_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'opportunity_type', 'enum', true,'{/literal}{sugar_translate label='LBL_TYPE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_NAME' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'sdr', 'enum', false,'{/literal}{sugar_translate label='LBL_SDR' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'custom_lead_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_LEAD_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'hosting_c', 'currency', false,'{/literal}{sugar_translate label='LBL_HOSTING' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'add_notes', 'text', false,'{/literal}{sugar_translate label='LBL_ADD_NOTES' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACT_LEAD_CONTACT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'social_engagement_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SOCIAL_ENGAGEMENT' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'website_design_description_c', 'text', false,'{/literal}{sugar_translate label='LBL_WEBSITE_DESIGN_DESCRIPTION_C' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'website_design_amount_c', 'currency', false,'{/literal}{sugar_translate label='LBL_WEBSITE_DESIGN_AMOUNT' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'number_post_c', 'int', false,'{/literal}{sugar_translate label='LBL_NUMBER_POST' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'rowData', 'text', false,'{/literal}{sugar_translate label='LBL_ROW_DATA' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_manager_c', 'enum', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_MANAGER' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'online_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_ONLINE_DATE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'hosting_mrr_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOSTING_MRR' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_panel_show', 'bool', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_SHOW' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_email', 'varchar', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_EMAIL' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'se_manager', 'function', false,'{/literal}{sugar_translate label='LBL_AOP_CASE_UPDATES_THREADED' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'ad_management_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AD_MANAGEMENT' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'email_mrr_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMAIL_MRR' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_phone', 'int', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_PHONE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'number_media_c', 'int', false,'{/literal}{sugar_translate label='LBL_NUMBER_MEDIA' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'webiste_maintenace_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_WEBISTE_MAINTENACE' module='Opportunities' for_js=true}{literal}' );
addToValidateRange('form_SubpanelQuickCreate_Opportunities', 'free_time_c', 'int', false, '{/literal}{sugar_translate label='LBL_FREE_TIME' module='Opportunities' for_js=true}{literal}', 0, 30);
addToValidate('form_SubpanelQuickCreate_Opportunities', 'opp_owner_c', 'dynamicenum', false,'{/literal}{sugar_translate label='LBL_OPP_OWNER' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'setup_fee_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SETUP_FEE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'contact_lead_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACT_LEAD' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'lead_account_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_NAME' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'totalCountRow', 'int', false,'{/literal}{sugar_translate label='LBL_ROW_COUNT' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'churned_c', 'bool', false,'{/literal}{sugar_translate label='LBL_CHURNED' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'term_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_TERM' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_description', 'text', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_DESCRIPTION' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_type', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_TYPE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'industry_c', 'enum', true,'{/literal}{sugar_translate label='LBL_INDUSTRY' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'ad_budget_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AD_BUDGET' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'contract_term_c', 'enum', true,'{/literal}{sugar_translate label='LBL_CONTRACT_TERM' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'email_c', 'currency', false,'{/literal}{sugar_translate label='LBL_EMAIL' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'on_boarding_incomplete_notes_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ON_BOARDING_INCOMPLETE_NOTES' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'project_status', 'enum', false,'{/literal}{sugar_translate label='LBL_PROJECT_STATUS' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'logo_design', 'int', false,'{/literal}{sugar_translate label='LBL_LOGO_DESIGN' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'on_boarding_incomplete_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ON_BOARDING_INCOMPLETE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'account_industary', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_INDUSTRY' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'contract_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_CONTRACT_DATE' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'payment_notes_c', 'text', false,'{/literal}{sugar_translate label='LBL_PAYMENT_NOTES' module='Opportunities' for_js=true}{literal}' );
...
addToValidateBinaryDependency('form_SubpanelQuickCreate_Opportunities', 'account_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ACCOUNT_NAME' module='Opportunities' for_js=true}{literal}', 'account_id' );
