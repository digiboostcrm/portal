...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_closed_advanced) && !empty($smarty.request.date_closed_advanced)}{$smarty.request.date_closed_advanced}{else}{$smarty.request.range_date_closed_advanced}{/if}' title='This is the day the contract is signed'   size="11" class="dateRangeInput">
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_closed_advanced }' title='This is the day the contract is signed'  tabindex='' size="11" class="rangeDateInput">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_closed_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_closed_advanced }' title='This is the day the contract is signed'  tabindex='' size="11" class="dateRangeInput" maxlength="10">
