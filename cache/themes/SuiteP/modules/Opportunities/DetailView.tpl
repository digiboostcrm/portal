...
{if !$fields.sdr.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.sdr.options)}
<input type="hidden" class="sugar_field" id="{$fields.sdr.name}" value="{ $fields.sdr.options }">
{ $fields.sdr.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.sdr.name}" value="{ $fields.sdr.value }">
{ $fields.sdr.options[$fields.sdr.value]}
{/if}
{/if}
...
{if !$fields.opp_owner_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.opp_owner_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.opp_owner_c.name}" value="{ $fields.opp_owner_c.options }">
{ $fields.opp_owner_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.opp_owner_c.name}" value="{ $fields.opp_owner_c.value }">
{ $fields.opp_owner_c.options[$fields.opp_owner_c.value]}
{/if}
{/if}
