...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SHOW_ON_EMPLOYEES' module='Employees'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_USER_HASH' module='Employees'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PSW_MODIFIED' module='Employees'}{/capture}
{$label|strip_semicolon}:
...
<span class="dateTime">
{assign var=date_value value=$fields.pwd_last_changed.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.pwd_last_changed.name}" id="{$fields.pwd_last_changed.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="{$fields.pwd_last_changed.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.pwd_last_changed.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.pwd_last_changed.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
addToValidate('EditView', 'custom_user_type', 'varchar', false,'{/literal}{sugar_translate label='LBL_USER_TYPE' module='Employees' for_js=true}{literal}' );
