...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.direction.name}-input', '{$fields.direction.name}');sync_{$fields.direction.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
...
addToValidate('EditView', 'created_from_c', 'enum', true,'{/literal}{sugar_translate label='LBL_CREATED_FROM' module='Calls' for_js=true}{literal}' );
