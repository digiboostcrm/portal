...
{if !$fields.account_status_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.account_status_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.account_status_c.name}" value="{ $fields.account_status_c.options }">
{ $fields.account_status_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.account_status_c.name}" value="{ $fields.account_status_c.value }">
{ $fields.account_status_c.options[$fields.account_status_c.value]}
{/if}
{/if}
...
{if !$fields.content_files_c.hidden}
{counter name="panelFieldCount" print=false}
{if strlen($fields.content_files_c.value) <= 0}
{assign var="value" value=$fields.content_files_c.default_value }
{else}
{assign var="value" value=$fields.content_files_c.value }
{/if}
...
{if !empty($file)}
<li>
<a href="index.php?entryPoint=download2&file_path=multi_{$record_id}&field_name={$fields.content_files_c.name}&file_name={$file|urlencode}" target="_blank">{$file}</a>
</li>
{/if}
{/foreach}
</ul>
...
{if !$fields.created_from_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.created_from_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.created_from_c.name}" value="{ $fields.created_from_c.options }">
{ $fields.created_from_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.created_from_c.name}" value="{ $fields.created_from_c.value }">
{ $fields.created_from_c.options[$fields.created_from_c.value]}
{/if}
{/if}
...
{if !$fields.facebook_username_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.facebook_username_c.name}">{$fields.facebook_username_c.value}</span>
{/if}
...
{if !$fields.facebook_password_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.facebook_password_c.name}">{$fields.facebook_password_c.value}</span>
{/if}
...
{if !$fields.instagram_username_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.instagram_username_c.name}">{$fields.instagram_username_c.value}</span>
{/if}
...
{if !$fields.instagram_password_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.instagram_password_c.name}">{$fields.instagram_password_c.value}</span>
{/if}
...
{if !$fields.twitter_username_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.twitter_username_c.name}">{$fields.twitter_username_c.value}</span>
{/if}
...
{if !$fields.twitter_password_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.twitter_password_c.name}">{$fields.twitter_password_c.value}</span>
{/if}
...
{if !$fields.linkedin_username_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.linkedin_username_c.name}">{$fields.linkedin_username_c.value}</span>
{/if}
...
{if !$fields.linkedin_password_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.linkedin_password_c.name}">{$fields.linkedin_password_c.value}</span>
{/if}
...
{if !$fields.pinterest_password.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.pinterest_password.name}">{$fields.pinterest_password.value}</span>
{/if}
...
{if !$fields.pinterest_number.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.pinterest_number.name}">{$fields.pinterest_number.value}</span>
{/if}
