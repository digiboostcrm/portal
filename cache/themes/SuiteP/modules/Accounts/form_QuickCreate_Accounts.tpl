...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_QuickCreate_Accounts","field_to_name_array":{"id":"parent_id","name":"parent_name"}}{/literal}, 
"single", 
true
...
addToValidate('form_QuickCreate_Accounts', 'bank_saving', 'bool', false,'{/literal}{sugar_translate label='LBL_BANK_SAVING' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'facebook_password_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FACEBOOK_PASSWORD' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'linkedin_username_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LINKEDIN_USERNAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'credit_card_expire', 'varchar', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_EXPIRE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'bank_acc_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANK_ACC_NUMBER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'bank_acc_title', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANK_ACC_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'credit_card_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'facebook_username_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FACEBOOK_USERNAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'twitter_username_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TWITTER_USERNAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'instagram_username_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_INSTAGRAM_USERNAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'linkedin_password_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LINKEDIN_PASSWORD' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'twitter_password_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TWITTER_PASSWORD' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'ccv_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_CCV' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'billing_day_c', 'enum', true,'{/literal}{sugar_translate label='LBL_BILLING_DAY' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'account_manager_c', 'enum', true,'{/literal}{sugar_translate label='LBL_ACCOUNT_MANAGER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'bank_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANK_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'credit_card_amex', 'bool', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_AMEX' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'pinterest_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_PINTREST_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'billing_frequecy', 'enum', false,'{/literal}{sugar_translate label='LBL_BILLING_FREQUECY' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'created_from_c', 'enum', true,'{/literal}{sugar_translate label='LBL_CREATED_FROM' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'active', 'bool', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'content_files_c', 'Multiupload', false,'{/literal}{sugar_translate label='LBL_CONTENT_FILES' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'bank_checking', 'bool', false,'{/literal}{sugar_translate label='LBL_BANK_CHECKING' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'instagram_password_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_INSTAGRAM_PASSWORD' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'account_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_STATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'cardholders_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CARDHOLDERS_NAME' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'credit_card_number', 'varchar', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'bank_city', 'varchar', false,'{/literal}{sugar_translate label='LBL_BANK_CITY' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'auto_account_number', 'int', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'credit_card_discover', 'bool', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_DISCOVER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'on_boarding', 'bool', false,'{/literal}{sugar_translate label='LBL_ON_BOARDING' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'credit_card_master', 'bool', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_MASTER' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'account_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_NUMBER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'bank_routing', 'int', false,'{/literal}{sugar_translate label='LBL_BANK_ROUTING' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'name_on_bank_acct_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME_ON_BANK_ACCT' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'pinterest_password', 'varchar', false,'{/literal}{sugar_translate label='LBL_PINTREST_PASSWORD' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'credit_card_visa', 'bool', false,'{/literal}{sugar_translate label='LBL_CREDIT_CARD_VISA' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('form_QuickCreate_Accounts', 'parent_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_MEMBER_OF' module='Accounts' for_js=true}{literal}', 'parent_id' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['form_QuickCreate_Accounts_parent_name']={"form":"form_QuickCreate_Accounts","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["form_QuickCreate_Accounts_parent_name","parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["parent_id"],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}
