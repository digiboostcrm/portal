...
{/if} 
<span class="sugar_field" id="{$fields.user_hash.name}">{$fields.user_hash.value}</span>
{/if}
...
{if !$fields.factor_auth_interface.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.factor_auth_interface.options)}
<input type="hidden" class="sugar_field" id="{$fields.factor_auth_interface.name}" value="{ $fields.factor_auth_interface.options }">
{ $fields.factor_auth_interface.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.factor_auth_interface.name}" value="{ $fields.factor_auth_interface.value }">
{ $fields.factor_auth_interface.options[$fields.factor_auth_interface.value]}
{/if}
{/if}
