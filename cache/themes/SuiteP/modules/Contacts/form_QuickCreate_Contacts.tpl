...
addToValidate('form_QuickCreate_Contacts', 'email1', 'varchar', true,'{/literal}{sugar_translate label='LBL_EMAIL_ADDRESS' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'enable_portal_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ENABLE_PORTAL' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'user_answer', 'varchar', false,'{/literal}{sugar_translate label='LBL_USER_ANSWER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'register_from_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_REGISTERED_FROM' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'qbid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_QBID' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'username_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_USERNAME' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'contact_photo', 'image', false,'{/literal}{sugar_translate label='LBL_CONTACT_PHOTO' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'user_question', 'enum', false,'{/literal}{sugar_translate label='LBL_USER_QUESTION' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'bc_user_group_contacts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_BC_USER_GROUP_CONTACTS_FROM_BC_USER_GROUP_TITLE' module='Contacts' for_js=true}{literal}' );
