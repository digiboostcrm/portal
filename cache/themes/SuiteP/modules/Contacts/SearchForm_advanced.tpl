...
{html_options id='lead_source_advanced' name='lead_source_advanced[]' options=$fields.lead_source_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.lead_source_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='_advanced'>{sugar_translate label='' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields._advanced.value) <= 0}
{assign var="value" value=$fields._advanced.default_value }
{else}
{assign var="value" value=$fields._advanced.value }
{/if}  
<input type='text' name='{$fields._advanced.name}' 
    id='{$fields._advanced.name}' size='30' 
