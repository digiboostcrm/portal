...
<input type="text" name="{$fields.bc_user_group_contacts_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.bc_user_group_contacts_name.name}" size="" value="{$fields.bc_user_group_contacts_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.bc_user_group_contacts_name.id_name}" 
id="{$fields.bc_user_group_contacts_name.id_name}" 
value="{$fields.bc_user_group_contactsbc_user_group_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.bc_user_group_contacts_name.name}" id="btn_{$fields.bc_user_group_contacts_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.bc_user_group_contacts_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"bc_user_group_contactsbc_user_group_ida","name":"bc_user_group_contacts_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.bc_user_group_contacts_name.name}" id="btn_clr_{$fields.bc_user_group_contacts_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.bc_user_group_contacts_name.name}', '{$fields.bc_user_group_contacts_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.bc_user_group_contacts_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'enable_portal_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ENABLE_PORTAL' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'user_answer', 'varchar', false,'{/literal}{sugar_translate label='LBL_USER_ANSWER' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'register_from_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_REGISTERED_FROM' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'qbid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_QBID' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'username_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_USERNAME' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'contact_photo', 'image', false,'{/literal}{sugar_translate label='LBL_CONTACT_PHOTO' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'user_question', 'enum', false,'{/literal}{sugar_translate label='LBL_USER_QUESTION' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'bc_user_group_contacts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_BC_USER_GROUP_CONTACTS_FROM_BC_USER_GROUP_TITLE' module='Contacts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'bc_user_group_contacts_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Contacts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_BC_USER_GROUP_CONTACTS_FROM_BC_USER_GROUP_TITLE' module='Contacts' for_js=true}{literal}', 'bc_user_group_contactsbc_user_group_ida' );
