...
<input type='text' name='{$fields.account_name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='title_advanced'>{sugar_translate label='LBL_TITLE' module='Contacts'}</label>
                            </div>
            <div class="form-item">
...
<input type="text" name="{$fields.campaign_name_advanced.name}"  class= "sqsEnabled sqsNoAutofill"    id="{$fields.campaign_name_advanced.name}" size="30" value="{$fields.campaign_name_advanced.value}" title='' autocomplete="off"  >
