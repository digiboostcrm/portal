...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='case_number_advanced'>{sugar_translate label='LBL_NUMBER' module='Cases'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.case_number_advanced.value) <= 0}
{assign var="value" value=$fields.case_number_advanced.default_value }
{else}
{assign var="value" value=$fields.case_number_advanced.value }
{/if}  
<input type='text' name='{$fields.case_number_advanced.name}' 
    id='{$fields.case_number_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_SUBJECT' module='Cases'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='account_name_advanced'>{sugar_translate label='LBL_ACCOUNT_NAME' module='Cases'}</label>
                            </div>
            <div class="form-item">
...
<input type="hidden"  id="{$fields.account_id_advanced.name}" value="{$fields.account_id_advanced.value}">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='priority_advanced'>{sugar_translate label='LBL_PRIORITY' module='Cases'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='priority_advanced' name='priority_advanced[]' options=$fields.priority_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.priority_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='Cases'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Cases'}</label>
                            </div>
            <div class="form-item">
