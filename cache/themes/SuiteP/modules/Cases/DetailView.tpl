...
{/if} 
<span class="sugar_field" id="{$fields.queue.name}">{$fields.queue.value}</span>
{/if}
...
{if !$fields.chat_description_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.chat_description_c.name|escape:'html'|url2html|nl2br}">{$fields.chat_description_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
