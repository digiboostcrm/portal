...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_QUEUE' module='Cases'}{/capture}
{$label|strip_semicolon}:
...
{counter name="panelFieldCount"  print=false}
<select tabindex="0"  name="queue" id="queue">{$options_queue}</select>
</div>
...
title='' tabindex="0" 
 >{$value}</textarea>
{literal}<script type="text/javascript" language="Javascript" src="include/javascript/tiny_mce/tiny_mce.js?v=inhhRmL7YfFWWwF0gQe3Rg"></script>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CHAT_DESCRIPTION_C' module='Cases'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CREATED_FROM' module='Cases'}{/capture}
{$label|strip_semicolon}:
...
addToValidate('EditView', 'category', 'enum', false,'{/literal}{sugar_translate label='LBL_CATEGORY' module='Cases' for_js=true}{literal}' );
