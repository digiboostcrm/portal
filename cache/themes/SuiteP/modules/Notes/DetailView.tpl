...
{sugar_translate label='LBL_NOTE_INFORMATION' module='Notes'}
</a>
...
{sugar_translate label='LBL_PANEL_ASSIGNMENT' module='Notes'}
</a>
</li>
</ul>
</li>
...
{if !$fields.notes_type.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.notes_type.options)}
<input type="hidden" class="sugar_field" id="{$fields.notes_type.name}" value="{ $fields.notes_type.options }">
{ $fields.notes_type.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.notes_type.name}" value="{ $fields.notes_type.value }">
{ $fields.notes_type.options[$fields.notes_type.value]}
{/if}
{/if}
