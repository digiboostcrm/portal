...
<input class="date_input" autocomplete="off" type="text" name="{$fields.estimated_start_date_advanced.name}" id="{$fields.estimated_start_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.estimated_end_date_advanced.name}" id="{$fields.estimated_end_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
