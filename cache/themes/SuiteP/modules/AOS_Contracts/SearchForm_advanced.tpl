...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='contract_account_advanced'>{sugar_translate label='LBL_CONTRACT_ACCOUNT' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.contract_account_advanced.name}"  class="sqsEnabled"   id="{$fields.contract_account_advanced.name}" size="" value="{$fields.contract_account_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.contract_account_id_advanced.name}" value="{$fields.contract_account_id_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.contract_account_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.contract_account_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"contract_account_id_advanced","name":"contract_account_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.contract_account_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.contract_account_advanced.name}.value = ''; this.form.{$fields.contract_account_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='opportunity_advanced'>{sugar_translate label='LBL_OPPORTUNITY' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.opportunity_advanced.name}"  class="sqsEnabled"   id="{$fields.opportunity_advanced.name}" size="" value="{$fields.opportunity_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.opportunity_id_advanced.name}" value="{$fields.opportunity_id_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.opportunity_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.opportunity_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"opportunity_id_advanced","name":"opportunity_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.opportunity_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.opportunity_advanced.name}.value = ''; this.form.{$fields.opportunity_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='start_date_advanced'>{sugar_translate label='LBL_START_DATE' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='end_date_advanced'>{sugar_translate label='LBL_END_DATE' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='total_contract_value_advanced'>{sugar_translate label='LBL_TOTAL_CONTRACT_VALUE' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.total_contract_value_advanced.value) <= 0}
{assign var="value" value=$fields.total_contract_value_advanced.default_value }
{else}
{assign var="value" value=$fields.total_contract_value_advanced.value }
{/if}

{assign var="id" value=$fields.total_contract_value_advanced.name }

{if isset($smarty.request.total_contract_value_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.total_contract_value_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
{html_options options=$fields.total_contract_value_advanced.options selected=$starting_choice}
</select>
...
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
    ...
    value='{if empty($smarty.request.range_total_contract_value_advanced) && !empty($smarty.request.total_contract_value_advanced)}{$smarty.request.total_contract_value_advanced}{else}{$smarty.request.range_total_contract_value_advanced}{/if}' tabindex='' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_total_contract_value_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_total_contract_value_advanced }' tabindex=''>    
</div> 
</span>
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='contract_type_advanced'>{sugar_translate label='LBL_CONTRACT_TYPE' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='contract_type_advanced' name='contract_type_advanced[]' options=$fields.contract_type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.contract_type_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='AOS_Contracts'}</label>
                            </div>
            <div class="form-item">
