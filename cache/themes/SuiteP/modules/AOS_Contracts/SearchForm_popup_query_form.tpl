...
<input class="date_input" autocomplete="off" type="text" name="{$fields.start_date_advanced.name}" id="{$fields.start_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="{$fields.start_date_advanced.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.end_date_advanced.name}" id="{$fields.end_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="{$fields.end_date_advanced.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
