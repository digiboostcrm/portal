...
addToValidate('form_SubpanelQuickCreate_Documents', 'contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_PORTAL_USER_CONTACT_ID' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'portal_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_PORTAL_ID' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'portal_user_c', 'relate', false,'{/literal}{sugar_translate label='LBL_PORTAL_USER' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'created_from_c', 'enum', true,'{/literal}{sugar_translate label='LBL_CREATED_FROM' module='Documents' for_js=true}{literal}' );
