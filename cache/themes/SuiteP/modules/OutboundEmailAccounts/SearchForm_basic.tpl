...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='name_basic'> {sugar_translate label='LBL_NAME' module='OutboundEmailAccounts'}</label>
					</div>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='mail_smtpuser_basic' >{sugar_translate label='LBL_USERNAME' module='OutboundEmailAccounts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.mail_smtpuser_basic.value) <= 0}
{assign var="value" value=$fields.mail_smtpuser_basic.default_value }
{else}
{assign var="value" value=$fields.mail_smtpuser_basic.value }
{/if}  
<input type='text' name='{$fields.mail_smtpuser_basic.name}' 
    id='{$fields.mail_smtpuser_basic.name}' size='30' 
    maxlength='100' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='mail_smtpserver_basic' >{sugar_translate label='LBL_SMTP_SERVERNAME' module='OutboundEmailAccounts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.mail_smtpserver_basic.value) <= 0}
{assign var="value" value=$fields.mail_smtpserver_basic.default_value }
{else}
{assign var="value" value=$fields.mail_smtpserver_basic.value }
{/if}  
<input type='text' name='{$fields.mail_smtpserver_basic.name}' 
    id='{$fields.mail_smtpserver_basic.name}' size='30' 
    maxlength='100' 
    value='{$value}' title=''  tabindex='-1'      >
		</div>
		<div class="search-clear"></div>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='OutboundEmailAccounts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
