...
if($_POST['file_name'] != '')
{
	...
	if(file_exists($_SERVER['DOCUMENT_ROOT'].'upload/multi_'.$_POST['record_id'].'/'.$_POST['field_id'].'/'.$file))
	{
		unlink($_SERVER['DOCUMENT_ROOT'].'upload/multi_'.$_POST['record_id'].'/'.$_POST['field_id'].'/'.$file);	
